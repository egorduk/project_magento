...
$installer->getConnection()->addColumn($installer->getTable('sales/quote'), 'delivery_insurance', [
    'type' => Varien_Db_Ddl_Table::TYPE_DECIMAL,
    'length' => '12,4',
    'nullable' => true,
    'default' => null,
...
$installer->getConnection()->addColumn($installer->getTable('sales/quote'), 'base_delivery_insurance', [
    'type' => Varien_Db_Ddl_Table::TYPE_DECIMAL,
    'length' => '12,4',
    'nullable' => true,
    'default' => null,
